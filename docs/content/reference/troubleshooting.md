...
Most of these come down to network reality or how openalex serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openalex rate-limits like any public site. openalex already paces
...
Where a surface is gated, openalex reads a cookie or token you supply
...
`openalex`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openalex actually did
